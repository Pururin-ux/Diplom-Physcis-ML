...
Diploma thesis: 71 pages, 14 figures, 2 tables, 30 references, 2 appendices.

\textbf{Keywords:} QUANTUM DOT, TIGHT-BINDING, SUPERELLIPSE,
LOW-ENERGY SPECTRUM, SURROGATE APPROXIMATION,
RIDGE REGRESSION, MLP,
STRUCTURED VALIDATION.\par

\textbf{Object of research} --- quantum dots of superelliptic shape on a square tight-binding lattice. \textbf{Subject of research} --- the energy spectrum, corresponding eigenstates of the discrete Hamiltonian, the dependence of \(E_0\) and \(dE_1\) on size and boundary shape, and their physically motivated surrogate approximation. \textbf{Aim of the work} --- to model the energy spectrum of these dots and test a physically motivated surrogate approximation; wave functions are treated as eigenstates of the spectral problem.
