...
\todo{Meaningful case: $n=1.2$, imbalance_ratio, $\rho \approx 0.416$, $p \approx 0.013$.}
...
\todo{Mention that imbalance_ratio and abs_delta_N_over_N are identical aliases if this is reflected in final step-09 cleanup.}
