...
\todo{aspect_ratio values: 0.67, 0.72, 0.78, 0.83, 0.89, 0.94, 1.0.}
...
\section{Bessel sanity check для n = 2, aspect_ratio = 1}
...
\begin{figure}[htbp]
  ...
  \caption{TODO: Bessel sanity check для кругового случая $n=2$, aspect_ratio = 1.}
\end{figure}

\section{Вырождение уровней и исключение dE2 из основных целей}
\todo{$dE_2$ for $n=2$, aspect_ratio = 1 is numerically zero across the inspected slice.}
...
\todo{max sublattice imbalance ratio about 2.16\%, largest at $n=1.2$, $a=24$, aspect_ratio = 1.0.}
